...
_$AdUnitMetricsStateImpl _$$AdUnitMetricsStateImplFromJson(
        Map<String, dynamic> json) =>
    _$AdUnitMetricsStateImpl(
      todayMetrics: (json['todayMetrics'] as List<dynamic>?)
          ?.map((e) => AdUnitMetrics.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$$AdUnitMetricsStateImplToJson(
        _$AdUnitMetricsStateImpl instance) =>
    <String, dynamic>{
