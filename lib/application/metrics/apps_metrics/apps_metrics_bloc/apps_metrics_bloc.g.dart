...
_$AppsMetricsStateImpl _$$AppsMetricsStateImplFromJson(
        Map<String, dynamic> json) =>
    _$AppsMetricsStateImpl(
      todayMetrics: (json['todayMetrics'] as List<dynamic>?)
          ?.map((e) => AppsMetrics.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$$AppsMetricsStateImplToJson(
        _$AppsMetricsStateImpl instance) =>
    <String, dynamic>{
