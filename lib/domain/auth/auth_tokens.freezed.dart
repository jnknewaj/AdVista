...
abstract class $AuthTokensCopyWith<$Res> {
  ...
  @useResult
  $Res call({String accessToken, String refreshToken, DateTime expiryTime});
}
...
class _$AuthTokensImpl with DiagnosticableTreeMixin implements _AuthTokens {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AuthTokens(accessToken: $accessToken, refreshToken: $refreshToken, expiryTime: $expiryTime)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('expiryTime', expiryTime));
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, accessToken, refreshToken, expiryTime);
...
abstract class _AuthTokens implements AuthTokens {
  const factory _AuthTokens(
      ...
      required final DateTime expiryTime}) = _$AuthTokensImpl;
