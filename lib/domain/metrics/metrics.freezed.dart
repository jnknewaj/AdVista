...
class _$MetricsImpl extends _Metrics with DiagnosticableTreeMixin {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Metrics(earnings: $earnings, impression: $impression, requests: $requests, matchRate: $matchRate, clicks: $clicks, eCPM: $eCPM, showRate: $showRate, cTR: $cTR)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'Metrics'))
